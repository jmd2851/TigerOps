...
export default function Edit() {
  ...
  const slides = [
    ...
    },
    {
      id: 2,
      route: "/menu/1",
      type: SlideTypes.MENU,
      date: "November 7, 2023",
      label: "",
      description: [
        "Chicken French- lightly breaded chicken breast, an served in a lemon sherry sauce",
        "Garlic Herb Roasted Potatoes",
        "Rice Pilaf",
        "House Salad w/ dressing",
        "Tiramisu",
        "Assorted Sodas",
      ],
    },
    ...
    },
    {
      ...
      label: "carrot day",
      description: [
        "Stuffed Shells- w/ florentine sauce or marinara sauce",
        "Baked Potato",
