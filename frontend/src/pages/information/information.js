...
export default function Information() {
  return (
    <Page
      title="Information"
      subtitle="Useful information regarding St. Peter's Kitchen and miscellaneous details about this website"
    >
        ...
        <Paper elevation={3} className="infoCard">
          <Stack direction="row" spacing={5} sx={{ minHeight: "400px" }}>
            <Stack direction="column" spacing={0} sx={{ width: "50%" }}>
              <PageHeader
                title="Contact"
                subtitle="Want to get in touch with St. Peter's Kitchen?"
              />
              <Divider />
            ...
            <Card sx={{ width: "50%" }} className="imageCard kitchenImg"></Card>
          </Stack>
        </Paper>
            ...
            <Stack direction="column" spacing={0} sx={{ width: "100%" }}>
              ...
              <div className="content">
                <Typography variant="h7">
                  Click{" "}
                  <a
                    href="https://github.com/jmd2851/TigerOps"
                    style={{ textDecoration: "underline" }}
                  >
                    this link
                  </a>{" "}
                  to access this application's documentation.
                </Typography>
              </div>
            </Stack>
          </Stack>
